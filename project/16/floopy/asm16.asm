...
;              cos16.bin is 512*16(4000H-10000H)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
code segment use16
     ...
     load_16cos_chs proc far
         ;head 0, track 1
         mov ax,COS16_SEG
         mov es,ax
         ;02 is the no of function, 0x12 is 18 sectors.
         mov ax,0212H
         mov bx,COS16_OFFSET
         ;track 1, the no 1 of sector
         mov cx,0101H
         ...
         ;02 is the no of function, 0x12 is 18 sectors.
         mov ax,0212H
         mov bx,COS16_OFFSET+2400H
         ;track 1, the no 1 of sector
         mov cx,0101H
         ;driver 0 is drive a, head 1.
         mov dx,0100H
         int 13H
         ret
     load_16cos_chs endp
