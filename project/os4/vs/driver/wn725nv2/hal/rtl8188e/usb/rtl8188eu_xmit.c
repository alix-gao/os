...
os_ret OS_CALLBACK xmit_tasklet_entry_point(os_u32 arg1, os_u32 arg2, os_u32 arg3, os_u32 arg4, os_u32 arg5, os_u32 arg6, os_u32 arg7)
{
    ...
    while (1) {
        ...
        rtl8188eu_xmit_tasklet(padapter);
    }
}
...
s32	rtl8188eu_init_xmit_priv(_adapter *padapter)
{
    ...
    do {
        HTASK handle;
        handle = create_task("usb_xmit_tasklet", xmit_tasklet_entry_point, WN725N_XMIT_TASK_PRIO, (os_u32) padapter, 0, 0, 0, 0, 0, 0);
...
if (padapter->registrypriv.mp_mode == 0)
{
	...
	if((pxmitframe->frame_tag&0x0f) == DATA_FRAMETAG)
	{
		    ...
		    (pattrib->dhcp_pkt != 1))
		{
			...
			fill_txdesc_vcs(pattrib, (u32 *) &ptxdesc->txdw4);
			fill_txdesc_phy(pattrib, (u32 *) &ptxdesc->txdw4);
