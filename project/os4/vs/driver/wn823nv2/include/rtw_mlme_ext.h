...
#define SURVEY_TO	    (0x100) // alic mod for scan (100)
#define REAUTH_TO		0x300 // alic mod for scan (300) //(50)
#define REASSOC_TO		0x300 // alic mod for scan (300) //(50)
...
#define set_survey_timer(mlmeext, ms) \
	do { \
		DBG_871X("%s set_survey_timer(%x, %d)\n", __FUNCTION__, (mlmeext), (ms)); \
		_set_timer(&(mlmeext)->survey_timer, (ms)); \
	} while(0)

#define set_link_timer(mlmeext, ms) \
	do { \
		DBG_871X("%s set_link_timer(%x, %d)\n", __FUNCTION__, (mlmeext), (ms)); \
