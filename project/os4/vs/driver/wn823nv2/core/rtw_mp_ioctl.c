...
NDIS_STATUS mp_ioctl_xmit_packet_hdl(struct oid_par_priv *poid_par_priv)
{
	PMP_XMIT_PARM pparm;
	PADAPTER padapter;
#ifdef CONFIG_MP_INCLUDED
...
//	DBG_871X("+mp_ioctl_xmit_packet_hdl\n");
	...
	mem_set((u8 *)(pattrib), 0, sizeof (struct pkt_attrib));
	...
	//
	mem_set(pxframe->mem, 0 , WLANHDR_OFFSET);
