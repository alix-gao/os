...
extern inline void ATOMIC_SET(ATOMIC_T *v, int i);
extern inline int ATOMIC_READ(ATOMIC_T *v);
extern inline void ATOMIC_ADD(ATOMIC_T *v, int i);
extern inline void ATOMIC_SUB(ATOMIC_T *v, int i);
