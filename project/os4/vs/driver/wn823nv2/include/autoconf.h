...
// task priority will affect the time order of rtw driver
#define RTW_DRIVER_RX_PRI (TASK_PRIORITY_3 + 0)
#define RTW_DRIVER_TX_PRI (TASK_PRIORITY_3 + 2)
#define RTW_DRIVER_CMD_PRI (TASK_PRIORITY_3 + 1)
