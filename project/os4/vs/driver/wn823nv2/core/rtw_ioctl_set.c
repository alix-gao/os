...
_func_enter_;
	...
	RT_TRACE(_module_rtl871x_ioctl_set_c_,_drv_info_,("rtw_set_802_11_add_wep:befor mem_cpy, wep->KeyLength=0x%x wep->KeyIndex=0x%x  keyid =%x\n",wep->KeyLength,wep->KeyIndex,keyid));
...
_func_enter_;
	...
	if((padapter->securitypriv.dot11AuthAlgrthm !=dot11AuthAlgrthm_8021X)&&(encryptionalgo== _WEP40_  || encryptionalgo== _WEP104_))
	{
		...
		RT_TRACE(_module_rtl871x_ioctl_set_c_,_drv_err_,("OID_802_11_ADD_KEY:Before mem_cpy \n"));
...
int rtw_set_country(_adapter *adapter, const char *country_code)
{
	...
	if(0 == str_cmp(country_code, "US"))
		channel_plan = RT_CHANNEL_DOMAIN_FCC;
	else if(0 == str_cmp(country_code, "EU"))
		channel_plan = RT_CHANNEL_DOMAIN_ETSI;
	else if(0 == str_cmp(country_code, "JP"))
		channel_plan = RT_CHANNEL_DOMAIN_MKK;
	else if(0 == str_cmp(country_code, "CN"))
		channel_plan = RT_CHANNEL_DOMAIN_CHINA;
	else if(0 == str_cmp(country_code, "IN"))
