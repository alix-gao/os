...
#define   MAX_JOIN_TIMEOUT	(6500 * 4) // alic mod for scan 6500
...
struct wifidirect_info{
	...
	u8						uuid[16];					// UUID
	u32						channel_list_attr_len;		//	This field will contain the length of body of P2P Channel List attribute of group negotitation response frame.
...
extern os_ret OS_CALLBACK rtw_join_timeout_handler(RTW_TIMER_HDL_ARGS);
extern os_ret OS_CALLBACK _rtw_scan_timeout_handler(RTW_TIMER_HDL_ARGS);
