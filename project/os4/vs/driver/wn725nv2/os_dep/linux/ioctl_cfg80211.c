...
static int rtw_cfg80211_monitor_if_xmit_entry(struct sk_buff *skb, struct net_device *ndev)
{
	...
	if ((frame_ctl & RTW_IEEE80211_FCTL_FTYPE) == RTW_IEEE80211_FTYPE_DATA) {
		...
		mem_cpy(dst_mac_addr, dot11_hdr->addr1, sizeof(dst_mac_addr));
		mem_cpy(src_mac_addr, dot11_hdr->addr2, sizeof(src_mac_addr));
		...
		mem_cpy(pdata, dst_mac_addr, sizeof(dst_mac_addr));
		mem_cpy(pdata + sizeof(dst_mac_addr), src_mac_addr, sizeof(src_mac_addr));
