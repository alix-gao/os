...
u4Byte	GLCoexVerDate8723b1Ant=20141215;
u4Byte	GLCoexVer8723b1Ant=0x56;
	...
	switch(type)
	{
		...
		case 4:
			if ((pCoexSta->nScanAPNum > 5) && (pCoexSta->bCCKEverLock) && (pCoexSta->bCCKLock))
				halbtc8723b1ant_CoexTable(pBtCoexist, bForceExec, 0x55aa5555, 0xaaaaaaaa, 0xffffff, 0x3);
	...
	)
{
		...
		if (GenCount== 1)
		{
			mem_cpy(pPsdScan->nPSDReport_MaxHold, pPsdScan->nPSDReport, BT_8723B_1ANT_ANTDET_PSD_POINTS*sizeof(u4Byte));
	...
	do
	{
		switch(flag)
		{
		  ...
		  case 2:  //set RF channel/BW/Mode
			...
			break;
		  case 3:
		  	mem_set(pPsdScan->nPSDReport,0, pPsdScan->nPSDPoint*sizeof(u4Byte));
	...
	)
{
	...
	mem_set(pPsdScan->nAntDet_PeakVal, 0, 16*sizeof(UCHAR));
	mem_set(pPsdScan->nAntDet_PeakFreq, 0, 16*sizeof(UCHAR));
