...
#define CONFIG_INTEL_PROXIM
#define CONFIG_XMIT_THREAD_MODE

#define WN725N_RECV_TASK_PRIO (TASK_PRIORITY_3 + 0)
#define WN725N_XMIT_TASK_PRIO (TASK_PRIORITY_3 + 2)
#define WN725N_CMD_TASK_PRIO (TASK_PRIORITY_3 + 1)
#endif
